...
- [X] create a simple textarea element to test it with the core.

### Code Complexity

- [X] install Acorn package
- [X] implement `getAST` function to convert text to AST
- [ ] install Acorn Walk package to watch the AST and calculate file complexity  

### Repo Scanner

Implement repo scanner to scan for:
